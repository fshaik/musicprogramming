...
//==============================================================================
Audiotry2AudioProcessor::Audiotry2AudioProcessor()
{
...
//==============================================================================
const String Audiotry2AudioProcessor::getName() const
{
	return JucePlugin_Name;
}

int Audiotry2AudioProcessor::getNumParameters()
{
	return 0;
}

float Audiotry2AudioProcessor::getParameter(int index)
{
	return 0.0f;
}

void Audiotry2AudioProcessor::setParameter(int index, float newValue)
{
}

const String Audiotry2AudioProcessor::getParameterName(int index)
{
	return String::empty;
}

const String Audiotry2AudioProcessor::getParameterText(int index)
{
	return String::empty;
}

const String Audiotry2AudioProcessor::getInputChannelName(int channelIndex) const
{
	return String(channelIndex + 1);
}

const String Audiotry2AudioProcessor::getOutputChannelName(int channelIndex) const
{
	return String(channelIndex + 1);
}

bool Audiotry2AudioProcessor::isInputChannelStereoPair(int index) const
{
	return true;
}

bool Audiotry2AudioProcessor::isOutputChannelStereoPair(int index) const
{
	return true;
}

bool Audiotry2AudioProcessor::acceptsMidi() const
{
...
bool Audiotry2AudioProcessor::producesMidi() const
{
...
bool Audiotry2AudioProcessor::silenceInProducesSilenceOut() const
{
	return false;
}

double Audiotry2AudioProcessor::getTailLengthSeconds() const
{
	return 0.0;
}

int Audiotry2AudioProcessor::getNumPrograms()
{
	return 0;
}

int Audiotry2AudioProcessor::getCurrentProgram()
{
	return 0;
}

void Audiotry2AudioProcessor::setCurrentProgram(int index)
{
}

const String Audiotry2AudioProcessor::getProgramName(int index)
{
	return String::empty;
}

void Audiotry2AudioProcessor::changeProgramName(int index, const String& newName)
{
}

//==============================================================================
void Audiotry2AudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void Audiotry2AudioProcessor::releaseResources()
{
...
void Audiotry2AudioProcessor::processBlock(AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
...
//==============================================================================
bool Audiotry2AudioProcessor::hasEditor() const
{
	return true; // (change this to false if you choose to not supply an editor)
}

AudioProcessorEditor* Audiotry2AudioProcessor::createEditor()
{
	return new Audiotry2AudioProcessorEditor(this);
}

//==============================================================================
void Audiotry2AudioProcessor::getStateInformation(MemoryBlock& destData)
{
...
void Audiotry2AudioProcessor::setStateInformation(const void* data, int sizeInBytes)
{
...
{
	return new Audiotry2AudioProcessor();
}